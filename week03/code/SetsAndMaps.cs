    ...
    public static string[] FindPairs(string[] words)
{
    ...
    {
        if (!wordSet.Contains(word)) continue; // Skip if already processed
    ...
    public static bool IsAnagram(string word1, string word2)
{
    ...
    string clean1 = new string(word1.ToLower().Where(char.IsLetterOrDigit).ToArray());
    string clean2 = new string(word2.ToLower().Where(char.IsLetterOrDigit).ToArray());
...
public static string[] EarthquakeDailySummary()
{
    ...
    foreach (var feature in featureCollection.Features)
    {
        ...
        string magnitude = feature.Properties.Mag?.ToString("0.0") ?? "N/A";
